 ...
 * @Author Ismael Alves
 * @Description Utilizado para centralizar as variaveis de ambiente utilizadas na aplicação
 * @Callback Objeto contendo os valores das variavies de ambiente ou valores padrões
*/
