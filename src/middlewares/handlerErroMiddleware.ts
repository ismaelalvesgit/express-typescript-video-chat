 ...
 * @Author Ismael Alves
 * @Description Function utilizado como middleware para realizar tratamento de erros e exeções para cada requisição da 
 * aplicação utilizado na Class localizado em ´@/config/server.ts´
 * @Callback exportação da function handlerErroMiddleware do tipo ErrorRequestHandler
*/
