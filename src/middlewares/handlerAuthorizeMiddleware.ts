 ...
 * @Author Ismael Alves
 * @Description Function utilizado como middleware para realizar autenticação do usuário
 * durante a requisição da aplicação, utilizado nas Class localizado em ´@/controllers/*.ts´
 * @Callback exportação da function authorize do tipo RequestHandler
*/
